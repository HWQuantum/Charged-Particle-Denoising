...
Pyrrole Experiment of the Project. The following describes how to generate training data and perform the training and evaluation on the captured results. Packaged with the code we include our real data.
